    ...
    private void initEvent() {
        PublicEvent.getInstance().addEventMain(new EventMain() {
            ...
            public void sendMessage(String message) {
                String idiomaDestino = "español"; // Idioma destino deseado

                try {
                    String[] resultados = TranslationService.corregirYTraducir(message, idiomaDestino);
                    String mensajeCorregido = resultados[0];
                    String mensajeTraducido = resultados[1];

                    loading.setMessage("Enviando mensaje...");

                    Service.getInstance().getClient().emit("send_message", mensajeTraducido);
