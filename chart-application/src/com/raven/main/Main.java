...
import com.raven.form.Loading;
import com.raven.form.Login;
import com.raven.form.VIew_Image;
...
public class Main extends javax.swing.JFrame {
    ...
    private void init() {
        ...
        // Otros inicializaciones y eventos
        initEvent();
    ...
    private void initEvent() {
        PublicEvent.getInstance().addEventMain(new EventMain() {
            ...
            public void sendMessage(String message) {
                // Ejemplo de envío de mensaje con corrección y traducción
                ...
                try {
                    ...
                    // Mostrar mensaje de envío en el componente de carga
                    loading.setMessage("Enviando mensaje...");

                    // Aquí envías el mensaje traducido al servidor utilizando el cliente Socket existente
    ...
    private void initComponents() {
        ...
        loading = new com.raven.form.Loading(); // Suponiendo que Loading tiene un método setMessage(String)
